...
combos.add_val(
    ...
    [
        ...
        "-SELECTION_METHOD lexicase -TEST_SAMPLING_METHOD random-sample -TEST_SAMPLING_PROP 0.2 -MAXMIN_POP_PROP 1.0 -PARTITIONING_METHOD none -COHORT_PARTITIONING_PROP 1.0",

        # informed - 0.1 parent sample, 0.05,0.1,0.2 ds
        ...
        "-SELECTION_METHOD lexicase -TEST_SAMPLING_METHOD maxmin-sample -TEST_SAMPLING_PROP 0.2 -MAXMIN_POP_PROP 0.1 -PARTITIONING_METHOD none -COHORT_PARTITIONING_PROP 1.0",

        # informed - 0.01 parent sample, 0.05,0.1,0.2 ds
        ...
        "-SELECTION_METHOD lexicase -TEST_SAMPLING_METHOD maxmin-sample -TEST_SAMPLING_PROP 0.2 -MAXMIN_POP_PROP 0.01 -PARTITIONING_METHOD none -COHORT_PARTITIONING_PROP 1.0",
    ]
)
...
combos.add_val(
    "POPULATIONS_FILE",
    [
        "specialists-t1-p100.csv",
        "specialists-t1-p200.csv",
        "specialists-t1-p50.csv",
        "specialists-t1-p10.csv"
    ]
)
