...
combos.add_val(
    ...
    [
        "-SELECTION lexicase -LEX_EPS 0 -LEX_DS_MODE none -LEX_DS_RATE 1.0 -LEX_DS_POP_RATE 1.0 -MAX_GENS 50000",
        "-SELECTION lexicase-even-lead -LEX_EPS 0 -LEX_DS_MODE none -LEX_DS_RATE 1.0 -LEX_DS_POP_RATE 1.0 -MAX_GENS 50000",

        "-SELECTION lexicase -LEX_EPS 0 -LEX_DS_MODE random -LEX_DS_RATE 0.5 -LEX_DS_POP_RATE 1.0 -MAX_GENS 100000",
        "-SELECTION lexicase -LEX_EPS 0 -LEX_DS_MODE random -LEX_DS_RATE 0.2 -LEX_DS_POP_RATE 1.0 -MAX_GENS 250000",
        "-SELECTION lexicase -LEX_EPS 0 -LEX_DS_MODE random -LEX_DS_RATE 0.1 -LEX_DS_POP_RATE 1.0 -MAX_GENS 500000",

        "-SELECTION lexicase -LEX_EPS 0 -LEX_DS_MODE maxmin-full -LEX_DS_RATE 0.5 -LEX_DS_POP_RATE 1.0 -MAX_GENS 100000",
        "-SELECTION lexicase -LEX_EPS 0 -LEX_DS_MODE maxmin-full -LEX_DS_RATE 0.2 -LEX_DS_POP_RATE 1.0 -MAX_GENS 250000",
        "-SELECTION lexicase -LEX_EPS 0 -LEX_DS_MODE maxmin-full -LEX_DS_RATE 0.1 -LEX_DS_POP_RATE 1.0 -MAX_GENS 500000",
    ]
)
