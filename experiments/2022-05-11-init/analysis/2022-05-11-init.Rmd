...
```{r}
ggplot(
    filter(summary_data, DIAGNOSTIC=="exploration"),
    aes(
      x=condition_name,
      y=ele_agg_per,
      fill=condition_name
...
```{r}
ggplot(
    filter(summary_data, DIAGNOSTIC=="weak-ecology"),
    aes(
      x=condition_name,
      y=pop_uni_obj,
      fill=condition_name
...
ggplot(
    ...
    filter(
      time_series_data,
      (ts_step%%1000)==0 & DIAGNOSTIC=="exploitation"
    ),
    aes(
      x=ts_step,
      y=ele_agg_per,
...
ggsave(
  paste0(working_directory, "plots/", "exploitation_ele_agg_per_ot.pdf"),
  width=15,
  height=10
)
```
...
ggplot(
    ...
    filter(
      time_series_data,
      (ts_step%%1000)==0 & DIAGNOSTIC=="struct-exploitation"
    ),
    aes(
      x=ts_step,
      y=ele_agg_per,
...
ggsave(
  paste0(working_directory, "plots/", "struct-exploitation_ele_agg_per_ot.pdf"),
  width=15,
  height=10
)
```
...
ggplot(
    ...
    filter(
      time_series_data,
      (ts_step%%1000)==0 & DIAGNOSTIC=="exploration"
    ),
    aes(
      x=ts_step,
      y=ele_agg_per,
...
ggsave(
  paste0(working_directory, "plots/", "exploration_ele_agg_per_ot.pdf"),
  width=15,
  height=10
)
```
...
ggplot(
    ...
    filter(
      time_series_data,
      (ts_step%%1000)==0 & DIAGNOSTIC=="weak-ecology"
    ),
    aes(
      x=ts_step,
      y=pop_uni_obj,
...
ggsave(
  paste0(working_directory, "plots/", "weak-ecology_pop_uni_obj.pdf"),
  width=15,
  height=10
)
```