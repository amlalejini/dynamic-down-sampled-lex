...
protected:
  ...
  emp::vector<size_t> selectable_candidates;  ///< IDs of candidates that are selectable
  emp::vector<size_t> use_fun_ids;            ///< IDs of functions to limit lexicase selection to

  // todo - add thing to track which tests allowed to use
...
public:
  ...
  // TODO - update to only compete candidates from 'selectable candidates', and only use
  // designated function ids
